class BaseEntity {
    ...
    getLocation(object, argumentss, canvasX, canvasY) { // eslint-disable-line
            let xCoord,
                yCoord,
                i = 0;
            argumentss = [].slice.call(argumentss);
            const that = this;
            that.coordinates = '';
            for (let argument of argumentss) {
    ...
    canvasLocator(object, argumentss, canvasX, canvasY) {
        let xCoord,
            yCoord,
            locX,
            locY,
